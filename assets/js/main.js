...
(function () {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    formData.append("access_key", "6e0be075-17bf-4f58-8585-2c403079b422");

    // Optional metadata (very useful)
    formData.append("subject", "New Lead – Nature Green Holidays");
    formData.append("from_name", "Nature Green Holidays Website");
...
(function () {
  ...
  document
    .querySelectorAll(".ngh-nav a, .ngh-mobile-nav__panel a")
    .forEach((a) => {
